...
let layersList = {
    ...
    'power-plants': {
        ...
        attr: {
            ...
            pointToLayer: function(feature, latlng) {
                let circle = new L.CircleMarker(latlng, {radius: base.radius_zoom()[base.map.getZoom()], stroke: false, weight: 0.3, fillOpacity: Math.min(0.85, Math.max(0.3, feature.properties.capacity_mw/2000)), fillColor: getColor(feature.properties.primary_fuel)});
                return circle;
            },
            onEachFeature: function (feature, layer) {
