...
omiYears.forEach(n => {
    layersList[`no2_${n}`] = {
        ...
        url: `https://raw.githubusercontent.com/decarbnow/data/master/layers/no2/World_${n}_rastered.geojson`,
        name: `NO<sub>2</sub> ${n}`
    }
});
...
tropomiDates.forEach(n => {
    layersList[`no2_${n[0]}_${String(n[1]).padStart(2, '0')}`] = {
        ...
        url: `https://raw.githubusercontent.com/decarbnow/data/master/layers/no2/World_${n[0]}_${String(n[1]).padStart(2, '0')}.geojson`,
